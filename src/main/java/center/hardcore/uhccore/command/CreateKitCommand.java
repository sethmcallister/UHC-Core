...
public class CreateKitCommand implements CommandExecutor
{
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String s, final String[] args)
    {
        ...
        Bukkit.getLogger().log(Level.SEVERE, String.format("%s has created a kit called %s: %s, %s", sender.getName(), kitName, Arrays.toString(armor.toArray()), Arrays.toString(items.toArray())));
        return true;
    }
}
